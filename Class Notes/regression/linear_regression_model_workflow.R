...
# Look at model summaries #### recidual=distance btw each point to the line 
summary(mod1)
summary(mod2)
summary(mod3)
...
mod1mse ; mod2mse ; mod3mse #the smallest number is the best model 
...
# which model is best? = mod3 
# + means ythe intercet to changeg while * allowes the slope and intercep to change 
