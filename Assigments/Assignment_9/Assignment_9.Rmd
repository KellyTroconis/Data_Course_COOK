...
```{r}
df <- read.csv(here("GradSchool_Admissions.csv"))
...
g3
ggsave("./Figures/fig3c.png")
```
We can see with the help of the plosts that, The greater the gpa, and gre the greater the probability to be admited. Ss well a,s the higher the rank of the school the the greater the probability to be admited
